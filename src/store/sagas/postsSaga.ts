...
import {
  getPosts,
  // getPost, deletePost, editPost, addPost
} from '../../API';
import {
...
// function* onAddPost(action: { type: string; name: string; email: string }) {
//   try {
//     let response = yield call(addPost, action.name, action.email);
//     const post = response.data;
